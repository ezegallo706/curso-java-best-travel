package com.curso_java.best_travel.infraestructure.services;

import com.curso_java.best_travel.api.models.request.ReservationRequest;
import com.curso_java.best_travel.api.models.responses.HotelResponse;
import com.curso_java.best_travel.api.models.responses.ReservationResponse;
import com.curso_java.best_travel.domain.entities.jpa.ReservationEntity;
import com.curso_java.best_travel.domain.repositories.jpa.CustomerRepository;
import com.curso_java.best_travel.domain.repositories.jpa.HotelRepository;
import com.curso_java.best_travel.domain.repositories.jpa.ReservationRepository;
import com.curso_java.best_travel.infraestructure.abstract_services.IReservationService;
import com.curso_java.best_travel.infraestructure.helpers.ApiCurrencyConnectorHelper;
import com.curso_java.best_travel.infraestructure.helpers.BlackListHelper;
import com.curso_java.best_travel.infraestructure.helpers.CustomerHelper;
import com.curso_java.best_travel.infraestructure.helpers.EmailHelper;
import com.curso_java.best_travel.util.enums.Tables;
import com.curso_java.best_travel.util.exceptions.IdNotFoundException;
